                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
						...
						<section class="text-gray-600 body-font relative">
							<form @submit.prevent="storeCustomer(form.id)">
										...
										<div class="flex flex-wrap -m-2">
											...
											<div class="p-2 w-full">
												<div class="relative">
													...
													<input type="numeber" id="postcode" name="postcode" v-model="form.postcode" @change="fetchAddress"  class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
												</div>
											</div>
											<div class="p-2 w-full">
												<div class="relative">
											...
											<div class="p-2 w-full">
												<div class="relative">
													...
													<input type="radio" id="gender0" name="gender" v-model="form.gender" value="0" class="mr-2">
													<label for="gender0" class="mr-4">男性</label>
													<input type="radio" id="gender1" name="gender" v-model="form.gender" value="1" class="mr-2">
													<label for="gender1" class="mr-4">女性</label>
													<input type="radio" id="gender2" name="gender" v-model="form.gender" value="2" class="mr-2">
													<label for="gender2" class="mr-24">その他</label>
												</div>
											</div>
											<div class="p-2 w-full">
												<div class="relative">
