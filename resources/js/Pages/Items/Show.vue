								...
								<div class="lg:w-1/2 md:w-2/3 mx-auto">
									<div class="flex flex-wrap -m-2">
										...
										<div class="p-2 w-full flex justify-between">
											<Link as="button" :href="route('items.edit',{item:item.id})" class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">編集する</Link>
											<button @click="deleteItem(item.id)" class="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">削除する</button>
										</div>
									</div>
								</div>
							</div>
