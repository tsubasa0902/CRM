										...
										<div class="flex flex-wrap -m-2">
											...
											<div class="p-2 w-full">
												<div>
													...
													<input class="ml-2 mb-1" type="radio" id="status" name="status" v-model="form.status" value="1"> 未キャンセル
													<input class="ml-2 mb-1" type="radio" id="status" name="status" v-model="form.status" value="0"> キャンセルする
												</div>
											</div>
											<div class="p-2 w-full">
