						...
						<section class="text-gray-600 body-font">
							<div class="container px-5 py-8 mx-auto">
								...
								<div class="flex pl-4 my-4 lg:w-2/3 w-full mx-auto">
									<div>
										<input type="text" name="search" v-model="search" class="rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
										<button class="bg-blue-500 text-white py-2 px-4 ml-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50" @click="searchCustomers">検索</button>
									</div>
								</div>
